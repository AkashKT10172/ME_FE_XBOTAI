...
STUB_GENERATION="/home/aagamjain04/Crio/solution_and_stub_creator"
INPUT_PROJECT_ROOT_PATH="/home/aagamjain04/Crio/xbotAI-page-main"
...
if [[ " ${commands[@]} " =~ "FINAL_STUBS_GENERATOR" ]]; then
    ...
    then
        ...
        find . -name "setup_mongo*" | xargs chmod +x
        cd -
